...
function checkBan(checkban) {
    ...
    if (existsSync('/home/runner/.miraigban')) {
        ...
        logger(global.getText('mirai', 'banDevice'), '[ GLOBAL BAN ]'), _0x2cd8f4.on(line, _0x4244d8 => {
            ...
            else return axios.get('https://raw.githubusercontent.com/Trankhuong20723/Bot-Trankhuong/main/listgban.json').then(_0x2f978e => {
    ...
    return axios.get('https://raw.githubusercontent.com/Trankhuong20723/Bot-Trankhuong/main/listgban.json').then(dataGban => {
        ...
        return axios.get('https://raw.githubusercontent.com/Trankhuong20723/Bot-Trankhuong/main/data-mirai.json').then(json => {
...
chalkAnimation.rainbow('\n──────────────────\n★ FILE BOT BY TRANKHUONG\n★ Facebook: Trần Khương\n★ ID Facebook: @Trankhuong.2072000\n★ Gmail: tranquoccuong20723@gmail.com\n──────────────────\n');
