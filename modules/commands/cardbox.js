...
/*---------------------------------------------*/
  ...
  ctx.textAlign = "start";
  fontSize = 20;
  ctx.fillText(`⊶ Số Lượng Thành Viên: ${threadMem}`, 439, 199);
  ctx.fillText(`⊶ Quản Trị Viên: ${qtv}`, 439, 243);
  ctx.fillText(`⊶ Nam: ${nam}`, 439, 287);
  ctx.fillText(`⊶ Nữ: ${nu}`, 439, 331);
  ctx.fillText(`⊶ Tổng Số Tin Nhắn Trong Nhóm: ${sl}`, 439, 379);
  ...
  ctx.textAlign = "start";
  fontSize = 20;
  ctx.fillText(`• Cùng Với ${parseInt(threadMem)-3} Người Khác...`, 607, 453);
  ctx.beginPath();
